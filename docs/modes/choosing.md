...
Modes are set at registration. To switch, `modak-worker unregister` (the lake table survives by default) and `register` again in the new mode. See [Day-2 operations](../operations/day-2.md#unregister).

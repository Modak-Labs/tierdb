...
/**
 * How a registered table keeps its lake copy. One frame unifies the modes: the
 * lake holds data below a frontier F, Postgres above a retention line R, and
 * reads split at a seam T with R &lt;= T &lt;= F.
 */

...
/**
 * The hot (Postgres) side of tiering: read a sealed partition out, physically
 * reclaim a tiered one. Reclaim is a partition <b>DROP/DETACH</b>, never a row
 * {@code DELETE} — aging-out must stay invisible to any CDC mirror.
 */

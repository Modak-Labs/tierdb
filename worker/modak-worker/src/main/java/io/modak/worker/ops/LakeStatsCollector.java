...
/** Persists a table's {@link LakeStats} into {@code modak.lake_stats} together with the maintenance policy in force. */
public final class LakeStatsCollector {

    private static final ObjectMapper MAPPER = new ObjectMapper();

    private static final String UPSERT = """
            INSERT INTO modak.lake_stats (table_id, stats, warnings, policy, collected_at)

...
/**
 * The mirrored-registration copy. PK-ordered chunks folded through the
 * merge writer (idempotent upserts), progress journaled in {@code
 * modak.copy_progress} after each chunk.
 */
public final class InitialCopy {

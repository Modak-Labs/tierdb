...
/**
 * Streams a JSONL file (one object per line, keys matching column names)
 * as rows in the given column order, validating each row's tier key
 * against the window as it goes.
 */
public final class JsonlRows implements Iterable<Object[]> {
